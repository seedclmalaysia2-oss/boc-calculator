...
export function HybridManagement({
  ...
  return (
    <section className="mt-8">
      ...
      {/* Clinical caution — the spectacle top-up is a starting estimate
          and must not be prescribed straight off these figures. */}
      <div className="mt-3.5 flex items-start gap-3 rounded-[12px] border border-no-line border-l-4 border-l-no bg-no-soft px-4 py-3.5">
        <svg
          className="mt-px flex-none text-no"
          width="20"
          height="20"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <div>
          <div className="font-display text-[12.5px] font-bold uppercase tracking-[0.08em] text-no">
            {T.hybridGlassesCautionTitle}
          </div>
          <p className="mt-1 text-[12px] leading-relaxed text-ink2">
            <Rich segs={T.hybridGlassesCaution} bold="font-bold text-ink" />
          </p>
        </div>
      </div>
